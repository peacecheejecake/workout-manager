...
훈련 기록·승인·인증·DB가 연결된 제품 앱이 아닙니다. 기존 Python FIT 코드는 별도 uv 환경으로 유지합니다.
...
corepack pnpm build          # tooling fixture production build
...
- `src/workout_manager`, `scripts/fitparse.py`: 기존 Python 도구. FIT batch는 후속 작업입니다.
