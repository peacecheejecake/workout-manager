...
export function createSessionTransport(
  ...
  return {
    async request(input) {
      ...
      if (
        !/^\/bff\/v1\/(?:plans|plan-scenarios|planner|nutrition|supplementary|stretching|routines|routine-versions|routine-schedule-previews|routine-schedules|routine-runs|coaching-threads|coaching-runs|coaching-candidates|joint-decisions|joint-candidates|coaching-constraints|evidence-snapshots|activities|activity-imports|check-ins|dashboard)(?:\/|\?|$)/.test(
          path,
        )
      )
