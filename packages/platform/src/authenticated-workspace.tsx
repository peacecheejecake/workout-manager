...
export function createSessionTransport(
  ...
  return {
    async request(input) {
      ...
      if (
        !/^\/bff\/v1\/(?:plans|plan-scenarios|coaching-threads|coaching-runs|coaching-candidates|coaching-constraints|evidence-snapshots|activities|activity-imports|check-ins|dashboard)(?:\/|\?|$)/.test(
          path,
        )
      )
