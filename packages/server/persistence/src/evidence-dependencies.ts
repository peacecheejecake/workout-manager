...
/** Capture core ledger heads inside an existing command transaction. */
export async function captureCoreEvidenceDependencies(
  transaction: Transaction,
): Promise<CoreEvidenceDependencyManifest> {
...
export function createEvidenceDependenciesRepository(
  ...
  return {
    capture(athleteId) {
      return database.tenant(athleteId, captureCoreEvidenceDependencies);
    },
  };
}
