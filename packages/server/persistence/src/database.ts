  ...
  async function transact<T>(
    ...
    try {
      ...
      const role = await client.query(
        "SELECT rolsuper, rolbypassrls, EXISTS (SELECT 1 FROM pg_class WHERE relname IN ('consent', 'outbox', 'command_receipt', 'plan_snapshot', 'plan_head', 'plan_history', 'plan_scenario', 'plan_scenario_revision', 'plan_scenario_application', 'coaching_constraint', 'coaching_constraint_head', 'coaching_thread', 'coaching_message', 'core_evidence_snapshot', 'coaching_run', 'coaching_analysis_output', 'coaching_decision', 'coaching_proposal', 'coaching_candidate', 'integrated_candidate_v4', 'integrated_approval_v4', 'recovery_strategy_history', 'routine_schedule_history', 'nutrition_plan_version', 'nutrition_plan_head', 'nutrition_plan_history', 'food_definition_version', 'food_definition_head', 'intake_entry', 'intake_entry_revision', 'integrated_dependency_head', 'supplementary_exercise_version', 'supplementary_exercise_head', 'supplementary_routine_version', 'supplementary_routine_head', 'supplementary_routine_target_ref', 'supplementary_session_link', 'supplementary_session_target_ref', 'supplementary_execution', 'supplementary_set_log', 'supplementary_set_log_revision', 'supplementary_rest_timer', 'routine_blueprint_version', 'routine_blueprint_head', 'routine_schedule_version', 'routine_schedule_head', 'routine_occurrence', 'routine_run', 'routine_run_revision', 'routine_checklist_confirmation', 'routine_step_timer', 'routine_command_receipt', 'stretch_profile', 'stretching_log', 'stretching_log_revision', 'recovery_method_version', 'recovery_method_head', 'recovery_strategy_version', 'recovery_strategy_head', 'recovery_action_log', 'recovery_action_revision', 'resource', 'resource_version', 'resource_object', 'resource_upload_intent', 'resource_object_cleanup', 'resource_url_ingestion', 'resource_url_ingestion_attempt', 'resource_url_fetch_hop', 'resource_url_artifact', 'resource_url_provenance', 'resource_url_locator', 'resource_share', 'resource_access_audit', 'resource_derived_cleanup', 'resource_passage', 'resource_retrieval_cache', 'resource_grounding', 'resource_grounding_excerpt', 'resource_citation', 'gallery_media_item', 'gallery_media_derivative', 'gallery_media_object', 'gallery_upload_intent', 'activity_canonical', 'activity_source_head', 'activity_source_revision', 'activity_overlay', 'activity_overlay_revision', 'activity_suppression', 'activity_import_receipt', 'tenant_erasure', 'operations_audit', 'garmin_connection', 'garmin_attempt', 'check_in', 'check_in_revision', 'check_in_receipt', 'check_in_collection_head', 'session_completion', 'session_completion_revision', 'session_completion_receipt', 'session_completion_collection_head', 'course_thumbnail', 'routing_admission', 'garmin_unofficial_connection', 'garmin_unofficial_run', 'garmin_activity_ledger', 'garmin_activity_ledger_source', 'course_deletion') AND relowner = pg_roles.oid) AS owns_tables FROM pg_roles WHERE rolname = current_user",
      );
