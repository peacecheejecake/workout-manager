...
it('exports coaching records only while evidence and AI consent remain available', async () => {
  ...
  if (before.schemaVersion !== 10) throw new Error('Expected coaching export v10');
  ...
  if (otherExport.schemaVersion !== 10) throw new Error('Expected coaching export v10');
  ...
  if (withdrawnArtifact.schemaVersion !== 10) throw new Error('Expected coaching export v10');
  ...
  if (guarded.schemaVersion !== 10) throw new Error('Expected coaching export v10');
