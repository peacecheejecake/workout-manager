...
describe('real PostgreSQL foundation', () => {
  it('uses checksum-tracked repeatable migrations', async () => {
    ...
    expect(result.rows).toEqual([
      ...
      { version: 41, checksum: expect.stringMatching(/^[a-f0-9]{64}$/) },
      { version: 42, checksum: expect.stringMatching(/^[a-f0-9]{64}$/) },
      { version: 43, checksum: expect.stringMatching(/^[a-f0-9]{64}$/) },
      { version: 44, checksum: expect.stringMatching(/^[a-f0-9]{64}$/) },
      { version: 45, checksum: expect.stringMatching(/^[a-f0-9]{64}$/) },
      { version: 46, checksum: expect.stringMatching(/^[a-f0-9]{64}$/) },
      { version: 47, checksum: expect.stringMatching(/^[a-f0-9]{64}$/) },
      { version: 48, checksum: expect.stringMatching(/^[a-f0-9]{64}$/) },
