...
후속 결정(2026-09-21): [지도 뷰어·자체 경로 생성 계획](../map-implementation-plan.md)에 따라
외부 상용 API 대신 자체 배경 지도·보행 엔진을 검증한다. 아래 hosted/demo 조사는 과거 증거다.
자체 운영도 데이터 license·한국 coverage·운영 자원 검증을 면제하지 않는다.
