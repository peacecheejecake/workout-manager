...
4. **M1-04 오늘/계획/활동/체크인**: M1-04a/b 체크인과 M1-04c/d 대시보드, M1-04e/f 활동 조회, M1-04g/h 수동 활동 계약/API와 입력·정정 UI를 순서대로 연결하고 활동 workbench에 합류한다. S03~S12 중 해당 업무를 실제 API/DB까지 연결. chart/table·empty/partial/error·반응형 완결. 개별 slice 완료를 전체 workbench 완료로 간주하지 않는다.
